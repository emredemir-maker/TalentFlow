...
export default function MaintenancePanel() {
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-3 space-y-4">
            <div className="flex items-center justify-between gap-2 flex-wrap">
                <div>
                    <h2 className="text-[12px] font-black text-slate-800">Bakım Süreci</h2>
                ...
                <div className="space-y-1.5">
                    ...
                    {allHandled && (
                        <div className="flex items-start gap-2.5 rounded-xl border border-emerald-100 bg-emerald-50 px-3.5 py-3">
                            ...
                            <div>
                                <p className="text-[11px] font-black text-emerald-800">Bakım süreci tamamlandı 🎉</p>
            ...
            {!health && !loading && (
                <p className="text-[10px] text-slate-400">Başlamak için "Durum Tespitini Başlat" düğmesine basın — tespit hiçbir veriyi değiştirmez, yalnızca rapor üretir.</p>
            )}
        </div>
    );
}
