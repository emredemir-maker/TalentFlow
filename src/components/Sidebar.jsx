        ...
        <>
            ...
            >
                ...
                {onCloseMobile && (
                    <button
                        onClick={onCloseMobile}
                        className="absolute top-3 right-3 w-8 h-8 rounded-md flex items-center justify-center text-n400 hover:text-n900 hover:bg-n100 transition-colors lg:hidden"
                        aria-label="Menüyü kapat"
                    >
                        <X className="w-5 h-5" />
                    </button>
                    ...
                    <div className={`flex items-center gap-3 px-2 py-2 ${collapsed ? 'lg:justify-center lg:px-0' : ''}`}>
                        <div className="w-9 h-9 rounded-full bg-brand-50 border border-n200 overflow-hidden shrink-0">
                             {userProfile?.imgUrl ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center text-brand text-xs font-semibold">
                ...
                <button
                    ...
                    className="absolute -right-3 top-10 w-6 h-6 bg-n0 border border-n200 rounded-full hidden lg:flex items-center justify-center text-n500 hover:text-n900 transition-all shadow-sm z-[60]"
