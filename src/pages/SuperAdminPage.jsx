    ...
    if (!isSuperAdmin) {
        return (
            <div className="p-8 flex flex-col items-center justify-center h-full text-center space-y-4">
                ...
                <h1 className="text-xl font-bold text-white">Erişim Reddedildi</h1>
        ...
        <div className="p-6 space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-electric text-white font-bold hover:bg-electric-light transition-all shadow-lg shadow-electric/20 active:scale-95"
                >
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                <button
                                                    ...
                                                    className={`p-2 rounded-lg transition-all flex items-center gap-1.5 ${copiedId === i.id ? 'bg-emerald-500/20 text-emerald-400' : 'bg-white/5 text-navy-400 hover:text-white hover:bg-white/10'}`}
                        ...
                        <form onSubmit={handleSendInvite} className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 bg-navy-900 border border-white/10 rounded-2xl text-white outline-none focus:border-electric transition-all"
                                />
                            </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select
                                    ...
                                    className="w-full px-5 py-4 bg-navy-900 border border-white/10 rounded-2xl text-white outline-none focus:border-electric transition-all appearance-none"
                                >
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-electric text-white font-bold rounded-2xl hover:bg-electric-light transition-all flex items-center justify-center gap-2 shadow-lg shadow-electric/20 active:scale-95 disabled:opacity-50"
                            >
